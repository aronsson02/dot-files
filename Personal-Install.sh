...
yay -Sy ckb-next-git youtube-dl pulseeffects yoshimi fontforge ktorrent gparted virt-manager qemu rawtherapee wine wine-mono wine-gecko firefox-developer-edition octopi-git
