...
theme.font_bold = 'SF Nodo Pro 15'
...
local awesome_overrides = function(theme)
    ...
    -- Foreground
    theme.fg_normal = '#BEC8D1DE'
    theme.fg_focus = '#BEC8D1'
    ...
    -- UI Groups
    theme.groups_title_bg = '#BEC8D1' .. '15'
    theme.groups_bg = '#BEC8D1' .. '10'
    theme.groups_radius = dpi(16)

    -- UI events
    theme.leave_event = transparent
    theme.enter_event = '#BEC8D1' .. '10'
    theme.press_event = '#BEC8D1' .. '15'
    theme.release_event = '#BEC8D1' .. '10'
    ...
    -- Menu
    theme.menu_font = 'SF Nodo Pro 14'
    theme.menu_submenu = '' -- ➤
    ...
    theme.menu_fg_normal = '#BEC8D1'
    theme.menu_fg_focus = '#BEC8D1'
    ...
    theme.taglist_bg_occupied =  '#BEC8D1' .. '1A'
    ...
    theme.tasklist_fg_urgent = '#BEC8D1'
